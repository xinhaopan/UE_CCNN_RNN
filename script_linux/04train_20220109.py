...
from unet1 import Unet,CE_Loss, Dice_loss, LossHistory,DeeplabDataset, deeplab_dataset_collate,f_score
...
if __name__ == "__main__":
    ...
    for startyear in years:
        ...
        dataset_path = "../traindata1_{}_0.75".format(str(startyear))
        inputs_size = [256,256,36]
        NUM_CLASSES = 2
