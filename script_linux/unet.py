...
class DeeplabDataset(Dataset):
    def __init__(self, train_lines, image_size, num_classes, dataset_path,startyear):
    ...
    def __getitem__(self, index):
        ...
        png = self.readTif(os.path.join(os.path.join(self.dataset_path, "labels" + str(self.startyear) + "/labels"), name + ".tif"))
