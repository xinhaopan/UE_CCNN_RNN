...
for weight in range(0,11):
    ...
    WriteTiff(im_data, path2, resultpath)
    ...
    ResultFile = "../urbanExpansion/plan3_w" + str(weight) + ".tif"
    ...
    WriteTiff(developmentProbability_arr, startpath, "../urbanExpansion/plan3_w" + str(weight)  + "_sp.tif")
    ...
    save_file = "../urbanExpansion/不同权重参数和精度.xlsx"
    ...
    worksheet1 = workbook.active
    worksheet1.append([now, "plan3_" + str(weight), OverAccury, kappa, Fom])
    workbook.save(filename=save_file)
