...
plans = ["ssp1", "ssp2", "ssp3", "ssp4", "ssp5"]
for plan in plans:
    df = pd.read_excel("../cityCount/count{}_{}.xlsx".format(str(startyear), str(endyear)),sheet_name = plan)

    filepath = "../Unet_result/suitability_plan3.tif"
    if not os.path.exists("../urbanFuture"):
        os.makedirs("../urbanFuture")

    ResultFile = "../urbanFuture/" + plan + ".tif"
    ...
    developmentProbability_arr = developmentProbability_arr * LoadData("../LUSD/conservation/c2020" + ".tif")
