...
for overlap in [0,0.5,0.75]:
    ...
    resultpath = r"D:\Work\doing\CNN_RNN\data\beijing\traindata{}_{}".format(startyear,str(overlap))
    pixarr_save = resultpath + "/pix_list{}.npy".format(startyear)
    label_dir = resultpath + "/urban{}.tif".format(startyear)
