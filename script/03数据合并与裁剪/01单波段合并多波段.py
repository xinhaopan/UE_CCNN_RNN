...
for year in L:
    ...
    data_dirs.append(r"D:\Work\doing\CNN_RNN\data\beijing\inputdata\distance" + "/d" + str(year) + ".tif.tif")
    path = r"D:\Work\doing\CNN_RNN\data\beijing\inputdata\all13"
    if not os.path.exists(path):
        os.makedirs(path)
    
    ResultPath = path + "/all" + str(year) + ".tif"
