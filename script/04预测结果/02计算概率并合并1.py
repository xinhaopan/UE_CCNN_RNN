...
def mosaic(in_files,output_name,arr_files):
    os.chdir(in_files)
    in_files1 = os.listdir(in_files)
    in_files = []
    for line in in_files1:
        if len(line) == 9:
...
startyear = 1985
print(startyear)
path = r"D:\Work\doing\CNN_RNN\data\beijing\traindata" + str(startyear) + "_0.75"
...
output_name1 = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/Unet_result/Suitability{}.tif".format(str(startyear))
